...
function (_React$Component) {
  ...
  function CustomerPage() {
    ...
    _this.handleRightPress = _this.handleRightPress.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
    _this.state = {
      view: 33
    };
    _this.max = 35;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CustomerPage, [{
    ...
    key: "handleRightPress",
    value: function handleRightPress() {
      while (true) {
        if (this.state.view == this.max) {
          this.setState({
            view: 0
    ...
    value: function render() {
      return __jsx("div", {
        ...
        onMouseDown: this.handleRightPress,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 58
        },
...
//# sourceMappingURL=customer.js.1e7cc8797417e13f4ed4.hot-update.js.map